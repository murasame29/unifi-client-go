...
func (c *Client) GetSDWANConfigByID(ctx context.Context, id string) (*types.SingleResponse[json.RawMessage], error) {
	resp, err := c.client.Get(ctx, fmt.Sprintf("/v1/sd-wan-configs/%s", id), nil)
	if err != nil {
		return nil, err
	}
